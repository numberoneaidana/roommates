...
import { getCurrentLang, t } from './i18n';// ─── Storage key ──────────────────────────────────────────────────────────────
...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    home: {
      ...
      featureList: [
        { icon: '🤖', title: 'Smart Algorithm', desc: 'Analyzes 40+ lifestyle parameters for precise matches' },
    ...
    swipe: {
      ...
      ofTotal: 'of',
      clickToView: '💬 Click card to view full profile',
      dragHint: '👈 ➡️ Drag to swipe or use buttons',
    },
  ...
  ru: {
    ...
    profile: {
      ...
      messageSentSub: 'Если ответят — откроется чат 💬',
      matched: '🤝 Совпадение!',
    ...
    swipe: {
      ...
      ofTotal: 'из',
      clickToView: '💬 Нажмите на карточку для просмотра',
      dragHint: '👈 ➡️ Перетащите или используйте кнопки',
    },
  ...
  kk: {
    ...
    home: {
      madeInKazakhstan: '🇰🇿 Қазақстан үшін жасалған',
      heroTitle: 'Өзіңізге',
      ...
      featureList: [
        { icon: '🤖', title: 'Ақылды алгоритм', desc: 'Дәл сәйкестікке арналған 40+ өмір салты параметрлерін талдайды' },
    ...
    swipe: {
      ...
      dragHint: '👈 ➡️ Сүйреңіз немесе түймелерді қолданыңыз',
    },
